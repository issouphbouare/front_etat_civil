...
export class EditAutreComponent {
  ...
  ngOnInit(): void {
    ...
    onGetFiles(a : any){
     ...
     onSubmit(){
      ...
      this.apiService.Update(this.autre._links.self.href, this.formEdit.value).
      subscribe( data => {
        console.log(data);
    ...
    upload(): void {
      ...
      if (this.selectedFiles) {
        ...
        if (file) {
          ...
          this.uploadService.upload(this.currentFile, (this.autre.id).toString()).subscribe(
            (event: any) => {
